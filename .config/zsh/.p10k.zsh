# Generated by Powerlevel10k configuration wizard on 2024-05-16 at 13:40 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='$P9K_IP_IP${P9K_IP_INTERFACE:+($P9K_IP_INTERFACE)}'
